...
func Deploy(logger log.Logger, fa *foundry.ArtifactsFS, srcFS *srcmap.SourceMapFS, cfg *WorldConfig) (*WorldDeployment, *WorldOutput, error) {
...
func createL1(logger log.Logger, fa *foundry.ArtifactsFS, srcFS *srcmap.SourceMapFS, cfg *L1Config) *script.Host {
...
func createL2(logger log.Logger, fa *foundry.ArtifactsFS, srcFS *srcmap.SourceMapFS, l2Cfg *L2Config, genesisTimestamp uint64) *script.Host {
...
func initialL1(l1Host *script.Host, cfg *L1Config) (*L1Deployment, error) {
	...
	l2GenesisScript, cleanupL2Genesis, err := script.WithScript[L2GenesisScript](l1Host, "L2Genesis.s", "L2Genesis")
	if err != nil {
...
func deploySuperchainToL1(l1Host *script.Host, superCfg *SuperchainConfig) (*SuperchainDeployment, error) {
	...
	l1DeployScript, cleanupL1Deploy, err := script.WithScript[DeployScript](l1Host, "Deploy.s", "Deploy")
	if err != nil {
...
func genesisL2(l2Host *script.Host, cfg *L2Config, deployment *L2Deployment) error {
	...
	l2GenesisScript, cleanupL2Genesis, err := script.WithScript[L2GenesisScript](l2Host, "L2Genesis.s", "L2Genesis")
	if err != nil {
